...
To walk through the basics, we turn the main component into a [Browser.element](https://package.elm-lang.org/packages/elm/browser/latest/Browser#elements). The html is moved from main into `view`
