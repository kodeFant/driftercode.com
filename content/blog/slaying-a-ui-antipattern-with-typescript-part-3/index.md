---
{
  ...
  "title": "How to typecheck data from an external source on the front end",
  "description": "Be more confident of the data you use in your app. Slaying a UI antipattern with TypeScript and React (part 3).",
